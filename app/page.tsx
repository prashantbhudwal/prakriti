    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="px-4 py-12 md:py-16">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-6 text-center text-3xl font-bold md:text-4xl bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
            About
          </h2>
          <Card className="border-purple-200 dark:border-purple-800">
            <CardContent className="p-6 md:p-8">
              <p className="text-pretty text-center text-lg leading-relaxed text-muted-foreground">
                ...
                Mumbai's premium salon expertise to every client. With special
                expertise in bobs, curly hair, and crazy colours, along with
                certifications from industry leaders like Wella, L'Oréal, and
                Davines, I strive to deliver exceptional results and stay at the
